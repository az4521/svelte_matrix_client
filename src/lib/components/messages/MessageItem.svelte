...
>
  ...
  <div class="flex-1 min-w-0">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <p class="text-xs text-discord-textMuted">
                  {videoLoading ? "Loading…" : "Click to play"}
                </p>
              </div>
            </div>
          {/if}
    ...
    {:else if msgtype === "m.audio"}
      ...
      >
        ...
        <div class="flex-1 min-w-0">
          <p class="text-discord-textPrimary text-xs font-medium truncate mb-1">
            {content?.body ?? "Audio"}
          </p>
          {#if audioBlobUrl}
            <!-- svelte-ignore a11y_media_has_caption -->
            <audio controls autoplay src={audioBlobUrl} class="w-full h-8"
            ></audio>
          {:else}
    ...
    {:else if msgtype === "m.file"}
      ...
      >
        ...
        <div class="min-w-0">
          <p class="text-discord-textPrimary text-sm font-medium truncate">
            {body()}
          </p>
  ...
  >
    ...
    {#if canPin}
      <button
        onclick={() =>
          isPinned ? unpinMessage(room, eventId) : pinMessage(room, eventId)}
    ...
    <div class="relative">
      <button
        ...
        onclick={() => {
          emojiPickerBelow =
            (reactionBtnEl?.getBoundingClientRect().top ?? 400) < 400;
