...
type RawGroup = { name: string; slug: string; emojis: { emoji: string; name: string; skin_tone_support: boolean }[] };

export const EMOJI_CATEGORIES: EmojiCategory[] = (groups as RawGroup[]).map((g) => ({
	id: g.slug,
